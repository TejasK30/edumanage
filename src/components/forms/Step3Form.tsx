  ...
  return (
    <div className="space-y-6">
      ...
      <div className="border p-4 rounded">
        ...
        <p>
          <strong>Admin Name:</strong> {step1Data.adminName}
        </p>
        <p>
          <strong>Admin Email:</strong> {step1Data.adminEmail}
        </p>
        <p>
          <strong>Admin Address:</strong> {step1Data.adminAddress}
        </p>
        <p>
      ...
      <div className="border p-4 rounded">
        <h3 className="font-semibold mb-2 text-secondary">Role Assignment</h3>
        <p>
